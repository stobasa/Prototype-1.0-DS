...
hedge_fund = ["hedge fund", "Absolute Return", "Accredited Investor", "Alpha", "Arbitrage", "Attribution", "Beta", "Correlation", "Drawdown", "Hurdle Rate",
    "Leverage", "Opportunistic", "Pairs Trading", "Portfolio Simulation", "Sharpe Ratio", "Short Rebate", "R-Squared", "Transportable Alpha", "Value at Risk"]
private_equity = ["Private equity", "Angel investing", "Venture capital", "Asset class", "Asset allocation", "Growth", "Buyout",  "Leveraged buyout", "LBO", "Distressed", "Turnaround", "Asset-backed", "Target", "Sponsor", "Independent Sponsor", "Fundless Sponsor", "Management", "Current ownership", "Anchor investor", "Co-investor", "Operating partners", "Due Diligence", "Teaser", "Deal memo", "deal pack", "Data room", "deal room", "QofE", "Quality of Earnings", "EBITDA", "Revenue", "Purchase multiple", "Enterprise value", "valuation", 'PE funds', "Direct investing", "Co-investing", "LP co-investing",
                  "Direct co-investing", "Primary issuances", "Secondary purchases", "Minimum", "Soft commitment", "Hard commitment", "Change of control", "Liquidation event", "Liquidity event", "Dividend", "Security", "Gross returns", "Net returns", "Holding period", "MOIC", "MOM", "IRR", "Current yield", "Carried interest", "Promote", "Performance-based fees", "Hurdle rate", "Preferred return", "Waterfall", "Sliding fee scale", "Closing fee", "Management fee", "IOI", "LOI", "SPV", "NDA", "Non-circ", "GP", "LP", "Committed capital", "Fund mandate", "Capital call", "Drawdown", "Vintage year", "J-curve"]
...
def checking_doc_type_result(filename):
    ...
    return result
>>>>>>> dae3878882ec1004669ac1d1844045a2006f476a
